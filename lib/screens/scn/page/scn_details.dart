  ...
  Widget voyageDetailsContent() {
    return Wrap(
      ...
      children: [
        ...
        infoBlock("ETA",vesselDetailsModel.eta != null ? Utils.formatStringUTCDate(vesselDetailsModel.eta,showTime: true) ?? "" : ""),
        infoBlock("ETD",vesselDetailsModel.etd != null ? Utils.formatStringUTCDate(vesselDetailsModel.etd,showTime: true) ?? "" : ""),
