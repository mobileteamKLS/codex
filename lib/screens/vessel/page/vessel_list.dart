...
import '../services/cubit/vessel_cubit.dart';
import '../services/cubit/vessel_state.dart';
...
class _VesselListingState extends State<VesselListing> {
  ...
  void initState() {
    ...
    _vesselCubit = context.read<VesselCubit>();
  ...
  void _scrollListener() {
    ...
    if (currentPosition >= (maxExtent - threshold)) {
      ...
      if (state is VesselLoaded && state.hasMoreData) {
  ...
  Widget _buildBody() {
    return BlocConsumer<VesselCubit, VesselState>(
